...
def decrypt():
    ...
    if password == "1234":
        ...
        Label(screen2, text="DENCRYPT", font="arial", fg="white", bg="#00bd56").place(x=10, y=0)
...
def main_screen():
    ...
    Label(text="enter secret key for encryption and decryption ",fg="black",font=("calibri")).place(x=10,y=170)
    code=StringVar()
